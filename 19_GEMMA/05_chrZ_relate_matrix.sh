...
$BCFTOOLS/bcftools view -t chrZ -S for_ful_mag_samples.txt $VCF | $BCFTOOLS/bcftools view -e 'AC==0 || AC==AN || F_MISSING > 0.1 || ALT="*"' -O v -o finches_chrZ_324_shapeit4_phased_rh_GF.vcf.gz
$BCFTOOLS/bcftools +prune -n 1 -w 20000bp --nsites-per-win-mode rand --random-seed 42 -O v -o finches_chrZ_324_shapeit4_phased_rh_GF_prune.vcf.gz finches_chrZ_324_shapeit4_phased_rh_GF.vcf.gz
$BCFTOOLS/bcftools index finches_chrZ_324_shapeit4_phased_rh_GF_prune.vcf.gz
